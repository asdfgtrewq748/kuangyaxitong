...
async function testPage() {
  ...
  try {
    ...
    // Take screenshot
    await page.screenshot({ path: 'test_artifacts/screenshots/geomodel_20260216_110005.png', fullPage: true });
    ...
    const result = {
      ...
      errors: errors,
      screenshot: 'test_artifacts/screenshots/geomodel_20260216_110005.png',
