...
async function testPage() {
  ...
  try {
    ...
    // Take screenshot
    await page.screenshot({ path: 'test_artifacts/screenshots/research_20260216_104218.png', fullPage: true });
    ...
    const result = {
      ...
      errors: errors,
      screenshot: 'test_artifacts/screenshots/research_20260216_104218.png',
