...
async function testPage() {
  ...
  try {
    ...
    // Take screenshot
    await page.screenshot({ path: 'test_artifacts/screenshots/mpi_20260216_103633.png', fullPage: true });
    ...
    const result = {
      ...
      errors: errors,
      screenshot: 'test_artifacts/screenshots/mpi_20260216_103633.png',
