<template>
  <figure class="nature-figure" role="img" :aria-label="aa('rsiFigureAria')">
    <figcaption class="nature-caption">
      <span class="fig-label">{{ aa('rsiFigureTag') }}</span> {{ aa('rsiFigureCaption') }}
    </figcaption>
...
<style scoped>
/* Nature-inspired figure styling */
.nature-figure {
  background: #FFFFFF;
...
/* Nature-style panel label - bold sans-serif */
.nature-label {
  font-family: "Helvetica", "Arial", sans-serif;
  font-size: 14px;
  font-weight: 700;
