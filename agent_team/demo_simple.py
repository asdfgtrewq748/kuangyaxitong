...
================================================================================
  ...
  Role-Based Agents (Coordinators):
    * Team Leader (Decision Maker) - Analyzes and coordinates
    * QA Specialist (Validation Expert) - Validates quality
    * Bug Hunter (Fixer) - Fixes issues
...
""")
    ...
    print(f"  [OK] Created: {leader_task.title}")
    ...
    print(f"  [OK] Created: {backend_task.title}")
    ...
    print(f"  [OK] Created: {frontend_task.title}")
    ...
    print(f"  [OK] Created: {bug_task.title}")
    ...
    print(f"  [OK] Created: {qa_task.title}")
    ...
    print(f"  [OK] Created: {testing_task.title}")

    # Wait a bit for tasks to process
    print("\n[Processing] Waiting for tasks to complete...")
    ...
    for task in all_tasks:
        ...
        if status:
            status_symbol = "[OK]" if status["status"] == "completed" else "[..]"
    ...
    print("[Team Leader (Decision Maker)]")
    ...
    print("\n[QA Specialist (Validation Expert)]")
    ...
    print("\n[Next Steps]")
    print("  * Read agent_team/GUIDE.md for detailed documentation")
    print("  * Customize schedule in agent_team/schedule_config.json")
    print("  * Use coordinator.create_task() to create custom optimization tasks")
    print("="*70 + "\n")
